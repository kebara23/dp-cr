  ...
  return (
    <div className="p-6 max-w-6xl">
      ...
      <div className="flex gap-2 mt-6">
        {["Todas", "arquitectura", "estructura", "electrico", "sanitario_mecanico"].map((d) => (
          <span key={d} className={`text-xs px-3 py-1.5 rounded-full cursor-pointer transition-colors ${
            d === "Todas" ? "bg-gray-900 text-white" : "bg-white border text-gray-600 hover:bg-gray-50"
          }`}>
            {d === "Todas" ? d : d.replace("_", " ")}
          </span>
        ))}
      </div>
